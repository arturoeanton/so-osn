...
### Inventario ring 0 vs ring 3 (snapshot 2026-05-22, post-FASE 10.6 sesión 4)
...
| Tests | hello_libc, libctest, ttytest, envtest, fptest, mmaptest, pipetest, fbtest, inputtest, kerntest, spawntest, exectest, forktest, waittest, sigtest, sigchldtest, pgrouptest, ofdtest, ptytest, fdedgetest, jobtest, alltest, user_hello (bare) | 23 | sanidad + ABI |
| **Total ELFs en disco** | | **~74** | en `/sd/bin/` poblado al build via `mtools` |
