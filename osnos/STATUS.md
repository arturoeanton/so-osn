...
a fg pgid), y **mini terminal emulator funcional** (`/bin/term`
spawnea sub-shell interactivo `/bin/minishell` en PTY) — todo
verificado por **14/14 tests automatizados** vía `/bin/alltest`.
