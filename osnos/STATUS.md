...
### Inventario ring 0 vs ring 3 (snapshot 2026-05-22, post-FASE 10.6 sesión 3)
...
| Tests | hello_libc, libctest, ttytest, envtest, fptest, mmaptest, pipetest, fbtest, inputtest, kerntest, spawntest, exectest, forktest, waittest, sigtest, sigchldtest, pgrouptest, ofdtest, ptytest, fdedgetest, alltest, user_hello (bare) | 22 | sanidad + ABI |
| **Total ELFs en disco** | | **~73** | en `/sd/bin/` poblado al build via `mtools` |
