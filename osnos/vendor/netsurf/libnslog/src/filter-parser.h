...
#ifndef YY_FILTER_SRC_FILTER_PARSER_H_INCLUDED
# define YY_FILTER_SRC_FILTER_PARSER_H_INCLUDED
/* Debug traces.  */
#ifndef FILTER_DEBUG
# if defined YYDEBUG
#if YYDEBUG
...
#endif /* !YY_FILTER_SRC_FILTER_PARSER_H_INCLUDED  */
