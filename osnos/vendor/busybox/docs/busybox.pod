...
Currently available applets include:
	...
	[, [[, ash, basename, cat, cp, cpio, cut, date, dirname, echo, env,
	envdir, envuidgid, false, grep, head, ls, lsattr, lsmod, lsof,
	lspci, lsscsi, lsusb, mkdir, mv, printf, pwd, pwdx, rm, rmdir,
	rmmod, sh, sleep, sort, tail, test, touch, tr, traceroute, tree,
	true, truncate, uniq, wc
