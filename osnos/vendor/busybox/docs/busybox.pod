...
Currently available applets include:
	...
	expand, factor, false, find, fold, grep, head, hexdump, ls, lsattr,
	lsmod, lsof, lspci, lsscsi, lsusb, md5sum, mkdir, more, mv, patch,
	printf, pwd, pwdx, readlink, realpath, rev, rm, rmdir, rmmod, sed,
	sh, sha1sum, sha256sum, sleep, sort, stat, strings, tac, tail, test,
	timeout, touch, tr, traceroute, tree, true, truncate, uniq, vi, wc,
	xargs
