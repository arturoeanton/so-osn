...
Currently available applets include:
	...
	[, [[, ash, awk, base64, basename, bc, cat, cksum, cp, cpio, cut,
	date, dc, dd, df, diff, dirname, du, echo, env, envdir, envuidgid,
	expand, factor, false, find, fold, free, grep, head, hexdump, kill,
	killall, ls, lsattr, lsmod, lsof, lspci, lsscsi, lsusb, md5sum,
	mkdir, more, mv, patch, printf, ps, pwd, pwdx, readlink, realpath,
	rev, rm, rmdir, rmmod, sed, sh, sha1sum, sha256sum, sleep, sort,
	stat, strings, tac, tail, test, timeout, top, touch, tr, traceroute,
	tree, true, truncate, uniq, uptime, vi, wc, xargs
