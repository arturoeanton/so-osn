cmd_scripts/kconfig/conf.o := clang -Wp,-MD,scripts/kconfig/.conf.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer   -DKBUILD_NO_NLS    -c -o scripts/kconfig/conf.o scripts/kconfig/conf.c
